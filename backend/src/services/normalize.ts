export interface NormalizableData {
  url: string; title?: string | null; description?: string | null; h1?: string | null; canonical?: string | null; images?: unknown[]; contentText?: string | null; rawHtml?: string | null;
}
export interface NormalizedData {
  url: string; title: string | null; description: string | null; h1: string | null; canonical: string | null; images: string[]; contentText: string | null; rawHtml: string | null;
}
